...
import { IconButton, Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, TextField, Select, FormControl, InputLabel, MenuItem } from "@mui/material";
import EditIcon from '@mui/icons-material/Edit';
import { Categorias, Fornecedores, Marcas, Produto, ProdutoDialogProps, Produtos, Unidades } from "interfaces/compraInterfaces";
...
function ProdutoBibEdit({ id, onCleanTextField }: ProdutoDialogProps) {
    ...
    const [fornecedor, setFornecedor] = useState<Fornecedores>({ listFornecedor: [] });
    ...
    return (
        <React.Fragment>
            ...
            <Dialog open={open} onClose={handleClose}>
                ...
                <DialogContent>
                    <DialogContentText>
                        Lembrando que não é permitido alterar produto com mesma descrições de outro produto já existente.
                    </DialogContentText>
                        ...
                        <>
                            <FormControl fullWidth margin='dense'>
                                <TextField 
                                    ...
                                    onChange={(e) => setProduto({ ...produto, listProduto: [{ ...produto.listProduto[0], nome: (e.target.value) }] })}
                                />
                            </FormControl>
                            <FormControl fullWidth margin='dense'>
                                ...
                                <Select 
                                    ...
                                    onChange={(e) => setProduto({ ...produto, listProduto: [{ ...produto.listProduto[0], catId: Number(e.target.value) }] })}
                                >
                            ...
                            <FormControl fullWidth margin='dense'>
                                ...
                                <Select 
                                    ...
                                    onChange={(e) => setProduto({ ...produto, listProduto: [{ ...produto.listProduto[0], marcaId: Number(e.target.value) }] })}
                                >
                            ...
                            <FormControl fullWidth margin='dense'>
                                ...
                                <Select 
                                    ...
                                    onChange={(e) => setProduto({ ...produto, listProduto: [{ ...produto.listProduto[0], unidadeId: Number(e.target.value) }] })}
                                >
                            ...
                            <FormControl fullWidth margin='dense'>
                                ...
                                <Select 
                                    ...
                                    onChange={(e) => setProduto({ ...produto, listProduto: [{ ...produto.listProduto[0], fornId: Number(e.target.value) }] })}
                                >
                ...
                <DialogActions>
                    ...
                    <Button onClick={handleSubmit} color='secondary'>Salvar</Button>
                </DialogActions>
            </Dialog>
        </React.Fragment>
    );
